...
- **Минусы:**
  - Скачивание HEVC видео требует дополнительного времени на перекодирование (обычно 3–8 секунд для файлов до 50 МБ). В контексте лимита Telegram на прямую отправку видео ботом (50 МБ) эта нагрузка признана приемлемой.
